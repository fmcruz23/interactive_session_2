...
# exp() is "e to whatever power is in the ()"  
  exp(5)
...
# Vector from 0-40, by 0.2 
ex_2 <- seq(from = 0, to = 40, by = 0.2)

# Vector from 1-5000, by 10
...
```{r}
  ...
  pop_logistic(capacity = 2680, init_pop = 230, rate = 0.32, time_yr = 2.4)
```
...
Now let's estimate the population over that range of times, given capacity = 2580, 
initial population = 230, rate, 0.32

```{r}
chipmunk_pop <- pop_logistic(capacity = 2680, init_pop = 230, rate = 0.32, time_yr = time_vec)
